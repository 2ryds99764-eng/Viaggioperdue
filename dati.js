  ...
  storie: {
    ...
    debartoli: {
      ...
      paragrafi: [
        ...
        "Era il 1978 quando Marco, ancora giovanissimo, prese in mano il baglio di famiglia — proprio mentre l'industria del Marsala vendeva numeri record in tutto il mondo. Nelle cantine trovò botti che nessuno apriva più da decenni, vino che risaliva almeno agli anni Quaranta senza che si conoscesse più la prima annata: era il perpetuo, quello che i marsalesi chiamavano stravecchio prima che il Marsala fortificato ne cancellasse quasi il ricordo.",
        ...
        "Fra i primi a comprenderne il valore fu Luigi Veronelli, il gastronomo che più di ogni altro ha saputo raccontare l'Italia del vino e del cibo nel Novecento, e che lo elogiò come esempio di chi aveva lottato per la propria terra. Il 19 dicembre 2021, la città di Marsala gli ha dedicato una piazza nel centro storico: un riconoscimento pubblico, tardivo ma definitivo, per chi aveva scelto di guardare indietro quando tutti guardavano avanti.",
...
            galleria: ["https://res.cloudinary.com/dspgc41gt/image/upload/PietreLevate_pietre_f0tqoq", "https://res.cloudinary.com/dspgc41gt/image/upload/PietreLevate_campagna_jxlbch", "https://res.cloudinary.com/dspgc41gt/image/upload/PietreLevate_vigna_ihmul7"],
    ...
    siciliaintro: {
      ...
      paragrafi: [
        "Anche il nome più antico dell'isola parla di tre. I Greci la chiamavano Trinacria — dalle parole treis e àkra, \"tre punte\" — per i suoi tre promontori estremi: Capo Peloro a nord-est, Capo Passero a sud, Capo Lilibeo a ovest. Il simbolo, tre gambe che corrono attorno a una testa di Medusa, compare già sulle monete greche del VII secolo avanti Cristo — mille anni prima che qualcuno pensasse di dividerla amministrativamente. La Sicilia, a quanto pare, insegnava il numero tre a chiunque la guardasse, molto prima di essere governata da qualcuno che decidesse di prenderla in parola.",
        "Anche il potere, quando arrivò, seguì lo stesso disegno. Gli arabi, che governarono l'isola per due secoli a partire dal IX, la suddivisero in valli — non valli nel senso geografico, ma amministrativo: la Val di Mazara a ovest, la Val di Noto a sud-est, e la misteriosa Val Dèmona a nord-est, che prende il nome da un insediamento fortificato di cui oggi restano solo tracce. La divisione sopravvisse ai Normanni, agli Svevi, agli Aragonesi — un'isola che per governarsi ha sempre avuto bisogno di riconoscersi in tre pezzi, mai in uno solo.",
    ...
    },
    {
      ...
      manifesto: {
        ...
        paragrafi: [
          ...
          "E poi ci sono le grandi tavole, che almeno una volta nella vita andrebbero provate, perché sono la memoria di chi ha scritto la storia della grande cucina.",
  ...
  schede: {
    ...
    artigiani: [
      ...
      },
      {
        ...
        immagine: "https://res.cloudinary.com/dspgc41gt/image/upload/IMG_8988_u8j3nn",
      ...
      },
      {
        ...
        immagine: "https://res.cloudinary.com/dspgc41gt/image/upload/IMG_8935_xkvgbw",
