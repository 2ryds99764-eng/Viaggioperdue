  ...
  storie: {
    ...
    debartoli: {
      ...
      paragrafi: [
        ...
        "Fra i primi a comprenderne il valore fu Luigi Veronelli, che lo elogiò come esempio di chi aveva lottato per la propria terra — lo stesso gastronomo che avrebbe premiato, anni dopo, gli 'Ndunderi de La Caravella ad Amalfi. Il 19 dicembre 2021, la città di Marsala gli ha dedicato una piazza nel centro storico: un riconoscimento pubblico, tardivo ma definitivo, per chi aveva scelto di guardare indietro quando tutti guardavano avanti.",
